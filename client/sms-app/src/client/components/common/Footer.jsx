...
function Footer() {
  ...
  return (
    <div>
      <footer class="bg-[#ea580c]  dark:bg-gray-900">
  <div class="mx-auto max-w-7xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      <div class=" dark:text-teal-300">
        <h1 className=' text-3xl tex-black font-medium'> Service<span >Hub</span></h1>
    ...
    {!isAuthenticated ? (
      ...
      <div>
        ...
        <ul class="mt-6 space-y-4 text-sm">
          <li>
            <Link to="services">
             <p href="#" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
              Plumbing
            </p>
            </Link>
          ...
          <li>
            <Link to="/services">
            <p  class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
              Painting
            </p>
