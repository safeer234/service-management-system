  ...
  return (
    <div className='mb-20'>
     ...
     <header className='bg-[#ea580c]'>
      <div className='flex flex-col md:flex-col lg:flex-row items-center justify-around gap-8 lg:gap-150 px-6 lg:px-0 text-center lg:text-left'>
        ...
        <div>
          ...
          <p className='py-5 text-white'>
            Get in touch with us for any questions<br className='hidden lg:block'/> or support
          </p>
        </div>

        <div>
          <img className='h-32 md:h-40 lg:h-50 mx-auto lg:mx-0' src={contactimg1} alt="" />
        </div>
      ...
      <div className='py-10 px-6 lg:px-30'>
        <h2 className='text-xl md:text-2xl font-medium'>Get In Touch</h2>
      </div>

      {/* main 2 */}

      <div className='lg:flex gap-2'>
        <div className='flex flex-col md:flex-col lg:flex-row gap-10 lg:gap-0'>

        {/* LEFT SIDE */}
        <div className='px-6 lg:px-30 flex flex-col items-center lg:items-start'>
          {/* (Your contact cards unchanged) */}

                {/* CARD */}
          <div className='mb-5 border-2 text-lg font-medium border-[#ea580c] rounded-3xl h-20 w-full max-w-sm lg:w-65 px-7 flex items-center gap-3'>
            <div>
...
<path d="M18.07 22h.35c.47-.02.9-.26 1.17-.64l2.14-3.09c.23-.33.32-.74.24-1.14s-.31-.74-.64-.97l-4.64-3.09a1.47 1.47 0 0 0-.83-.25c-.41 0-.81.16-1.1.48l-1.47 1.59c-.69-.43-1.61-1.07-2.36-1.82-.72-.72-1.37-1.64-1.82-2.36l1.59-1.47c.54-.5.64-1.32.23-1.93L7.84 2.67c-.22-.33-.57-.57-.97-.64a1.46 1.46 0 0 0-1.13.24L2.65 4.41c-.39.27-.62.7-.64 1.17-.03.69-.16 6.9 4.68 11.74 4.35 4.35 9.81 4.69 11.38 4.69ZM6.88 10.05c-.16.15-.21.39-.11.59.05.09 1.15 2.24 2.74 3.84 1.6 1.6 3.75 2.7 3.84 2.75.2.1.44.06.59-.11l1.99-2.15 3.86 2.57-1.7 2.46c-1.16 0-6.13-.24-9.99-4.1S4 7.06 4 5.91l2.46-1.7 2.57 3.86-2.15 1.99Z"></path>
          ...
          {/* CARD */}
          <div className='mb-5 border-2 text-lg font-medium border-[#ea580c] rounded-3xl h-20 w-full max-w-sm lg:w-65 flex items-center gap-3 px-7'>
            <div>
...
<path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m-8.61 10.79c.18.14.4.21.61.21s.43-.07.61-.21l1.55-1.21L18.58 18H5.41l4.42-4.42 1.55 1.21ZM20 6v.51l-8 6.22-8-6.22V6zm0 3.04v7.54l-4.24-4.24zm-11.76 3.3L4 16.58V9.04zM20 18"></path>
          ...
          {/* CARD */}
          <div className='border-2 text-lg font-medium border-[#ea580c] rounded-3xl h-20 w-full max-w-sm lg:w-65 flex items-center gap-3 px-7'>
            <div>
...
<path d="M16 10c0-2.21-1.79-4-4-4s-4 1.79-4 4 1.79 4 4 4 4-1.79 4-4m-6 0c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2"></path><path d="M11.42 21.81c.17.12.38.19.58.19s.41-.06.58-.19c.3-.22 7.45-5.37 7.42-11.82 0-4.41-3.59-8-8-8s-8 3.59-8 8c-.03 6.44 7.12 11.6 7.42 11.82M12 4c3.31 0 6 2.69 6 6 .02 4.44-4.39 8.43-6 9.74-1.61-1.31-6.02-5.29-6-9.74 0-3.31 2.69-6 6-6"></path>
        ...
        {/* RIGHT FORM */}
        <div className='rounded-2xl w-full max-w-md lg:w-120 lg:h-90 mx-auto lg:mx-0 shadow-[0_25px_60px_rgba(0,0,0,0.3)]'>

          <form onSubmit={handleSubmit}>
            <div className='px-6 lg:px-10 py-5'>
              <h3 className='text-center text-xl md:text-2xl mb-4 font-medium'>
                Message <span className='text-[#ea580c]'>Us</span>
              </h3>

              <input 
                className='border-b border-[#a3a3a3] w-full lg:w-100 mb-8'
                type="text"
              ...
              <div className='flex justify-center'>
                <button 
                  type="submit"
                  className='flex justify-center w-32 hover:scale-105 transition duration-300 h-9 text-white items-center rounded-3xl bg-[#ea580c]'
                >
                  Send Message
                </button>
              </div>
